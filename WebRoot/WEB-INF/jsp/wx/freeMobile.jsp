...
$(function () {
    ...
    addressInit("province","city","","不限","不限");
});
...
function loadData() {
    ...
    let city =  $("#city").val()!="请选择所在市"?$("#city").val():"";
...
<body id="homeContent">
<div class="tuiTitle">
    <div class="tuiTileCenter">免费靓号</div>
</div>
    ...
    <div data-v-2a84ec57="" class="selecter" style="margin-top:50px">
        ...
        <div class="swiper-container swiper-container-horizontal">
            ...
            <div class="filter" style="margin-top:0px;background: white">
                ...
                <div class="long" style="margin-top:-10px"><span>偏好</span>
                    <div class="filterCheck" style="margin:30px">
            ...
            <div class="content">
                <footer style="margin-top: -50px;padding: 10px;"><label class="reset" onclick="resetNum(this)">
                    重置
